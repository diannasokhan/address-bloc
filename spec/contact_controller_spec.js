...
describe('ContactController', () => {
    ...
    describe('#addContact()', () => {
        it('should add a single contact into the this.book',(done) => {
           this.book.addContact('Alice', '111-111-1111', 'd@gmail.com')
           .then((contact) => {
               expect(contact.name).toBe('Alice');
               expect(contact.phone).toBe('111-111-1111');
               expect(contact.email).toBe('d@gmail.com')
               done();
           })
           .catch((err) => {
               done();
    ...
    describe('#getContacts()', () => {
        ...
        it('should return an array of contacts when contacts are available', (done) => {
            this.book.addContact('Alice', '111-111-1111', 'a@gmail.com')
            .then(() => {
                this.book.getContacts()
            .then((contacts) => {
    ...
    describe('search methods', () => {
        ...
        describe("#search()", () => {
         ...
         describe('#delete', () => {
             it('should not remove and contacts that do not match the ID passed', (done) => {
